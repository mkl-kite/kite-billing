...
<div class="warranty">
<h2>ГАРАНТИЙНЫЙ ТАЛОН &#8470;<span class="wcode"><?php echo @$doc['document']; ?></span></h2>
...
<li>Гарантия действительна до <span class="term"><?php echo (@$doc['expired'])? cyrdate(@$doc['expired']):''; ?></span></li>
</ul>
<div class="note">
...
<div class="footer">
<div class="date"><span><?php echo (@$doc['document'])? cyrdate(@$doc['created']):''; ?></span><p>Дата</p></div>
